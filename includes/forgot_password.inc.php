...
if(isset($_POST['submit'])){
    ...
    $username = $_POST['username'];
     if(empty($email)){
        ...
        $code = new ManageUserView();
        $ans = $code->checkUser($username, $email);
...
try {
  ...
  //  $mail->addAddress('patricksakala259@gmail.com'); 

    $mail->isHTML(true);                                
    $mail->Subject = "Student Management System :  Recovery Password";
    $mail->Body    = 'Recovery Code: <b>'.$resetcode.'</b> Enter it in the field to reset your password';
                                ...
                                <div class="p-5">
                                    ...
                                    ?>
                                        <p class="mb-4">We get it, stuff happens. Just enter your email address below
                                            and we'll send you a reset code!</p>
                                    </div>
