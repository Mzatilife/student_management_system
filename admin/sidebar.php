            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="hod.php">HODs</a>
                        <a class="collapse-item" href="senate.php">Senate</a>
                        <a class="collapse-item" href="accounts.php">Accounts</a>
                        <a class="collapse-item" href="student.php">Students</a>
                        <a class="collapse-item" href="lecturer.php">Lecturers</a>
                        <a class="collapse-item" href="registrar.php">Registrar</a>
                        <a class="collapse-item" href="dos.php">Dean of students</a>
                    </div>
                </div>
            </li>
