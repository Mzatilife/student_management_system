...
if(isset($_GET['code'])){
    $code = $_GET['code'];
    $_SESSION['code'] = $code;
    header("refresh:0, url=viewarchives.php");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="card-body">
                                ...
                                <?php 
                                    ...
                                    foreach($row as $rw){ ?>
                                    <a href="archives.php?code=<?php echo $rw['program_code']; ?>" class="btn btn-outline-info btn-block"><?php echo $rw['program_name']; ?></a>            
                                    <?php } ?>
                                                <!-- End of Form -->
</div>
</div>
