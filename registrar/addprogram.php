...
if (isset($_POST['add']))
{
    ...
    $pgcode = $_POST['pgcode'];
    $fID = $_POST['faculty'];
    $msg = $upload->addProgram($fID, $pgname, $pgcode);  
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Registar | Add Program</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 col-lg-10">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Upload Program</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                            ...
                            <?php
                                ...
                                <div class="row">
                                  <div class="form-group col-lg-6">
                                    <label class=" form-control-label">Faculties</label>
                                      <select class="form-control selectpicker" data-live-search="true" name="faculty">
                                  ...
                                  <div class="form-group col-lg-6">       
                                    ...
                                    <input type="text" name="pgcode" placeholder="i.e. CEN" class="form-control" required>
                                  </div>
                                  </div>
                                  <div class="form-group col-lg-12">       
                                    <label class="form-control-label">Program Name</label>
                                    <input type="text" name="pgname" placeholder="i.e. computer engineering" class="form-control" required>
                                  </div>
                                  <div class="form-group">       
                                    <input type="submit" value="Add Program" name="add" class="btn btn-info">
                                  </div>
                                </form>
                              </div>
                            </div>
